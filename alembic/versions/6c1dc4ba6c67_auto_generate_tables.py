"""auto_generate_tables

Revision ID: 6c1dc4ba6c67
Revises: 
Create Date: 2024-05-04 12:03:30.566289
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('role', sa.Enum('admin', 'customer', 'seller', name='role'), server_default='customer', nullable=False))
